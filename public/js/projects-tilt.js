...
// $('.projects__item').removeClass('animate');
...
//     const centerX = card.offsetLeft + cardWidth / (3 / 2);
//     const centerY = card.offsetTop + cardHeight / 2;
//     const mouseX = event.clientX - centerX;
//     const mouseY = event.clientY - centerY;
//     const rotateXUncapped = (+1) * tiltEffectSettings.max * mouseY / (cardHeight / 1.4);
...
//     projects.style.transform = `perspective(${tiltEffectSettings.perspective}px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) 
